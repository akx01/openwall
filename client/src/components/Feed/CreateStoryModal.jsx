  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md md:max-w-2xl rounded-3xl bg-white dark:bg-navy-800 p-6 space-y-4 border border-gray-100 dark:border-white/5 shadow-2xl animate-scale-in max-h-[95vh] md:max-h-[90vh] overflow-y-auto no-scrollbar"
      >
        {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="space-y-4">
            {/* Story Text Input */}
            <div className="space-y-1">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Story Text</p>
              <textarea
                value={content}
              ...
              <div className="grid grid-cols-4 gap-2">
                {STORY_THEMES.map((t) => (
                  <button
                    ...
                    className={`py-2 rounded-xl text-center text-[10px] font-bold text-white shadow-sm border transition-all ${t.bg} ${
